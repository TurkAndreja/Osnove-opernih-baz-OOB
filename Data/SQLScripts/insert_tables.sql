-- Active: 1723049753634@@baza.fmf.uni-lj.si@5432@sem2024_nezako
...
INSERT INTO uporabnik (username, password, id_operne_hise) VALUES ('andreja.turk@operabalet-lj.si', 'operabaletlj', 1);

DELETE FROM opera WHERE id = 4;
